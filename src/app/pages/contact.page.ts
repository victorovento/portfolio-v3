...
@Component({
  ...
  template: `
    ...
    <section class="box">
      <div class="box-title">new_message.eml</div>
      <div class="box-body mail">
        <app-pixel name="mail" [scale]="5" />
        <div>
          <p>
            Have a question, an opportunity, or just want to say hi?
            My inbox is always open. I read every email, even the ones about my cat.
          </p>
          <p class="address"><a [href]="'mailto:' + personal.email">{{ personal.email }}</a></p>
          <a class="btn" [href]="'mailto:' + personal.email">► send me an email</a>
        </div>
      </div>
    </section>

    <section class="box">
      <div class="box-title">find me elsewhere</div>
      <ul class="box-body socials">
        <li>
  ...
  styles: [`
    ...
    @media (max-width: 560px) {
      .mail { flex-direction: column; align-items: center; }
    }
  `],
})
